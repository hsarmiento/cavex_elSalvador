...
<html lang="es">
	...
	<body>
		<header>
			<div id="nav-header">
			    <div id="bar-one"></div>
			    <div id="title-nav"><a href="/cavex_elSalvador/home.php">Cavex Control System</a></div>
			    <div id="bar-two"></div>
			...
			<div class="menu">
				<div class="pull-center">
					<ul class="nav nav-pills">
						...
						<li><a href="/cavex_elSalvador/system_calibration.php">System calibration</a></li>
					  	<li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="/cavex_elSalvador/radios.php">View radios</a></li>
						  	</ul> 
					  </li>
					  <?php } ?>				  
					  ...
					  <?php } ?>
					  <?php if($_SESSION['usertype'] == 1){?>
					  	<li><a href="/cavex_elSalvador/change_title.php">Change title</a></li>
					  <?php } ?>
					  <li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="/cavex_elSalvador/logout.php">Logout</a></li>
					  	</ul> 
					  </li>
					</ul>
				</div>
