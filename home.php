				...
				<p>
				  <button class="btn btn-L btn-primary" type="button" onclick="window.location.href='/cavex_elSalvador/system_calibration.php'">System Calibration</button>
					...
					<div id="radio_collapse" class="collapse" style="margin-bottom:10px">
					  	<button class="btn btn-sub btn-primary" type="button" onclick="window.location.href='/cavex_elSalvador/add_radio.php'">Add radio</button>
				  		<button class="btn btn-sub btn-primary" type="button" onclick="window.location.href='/cavex_elSalvador/radios.php'">View radios</button>
				  	</div>	
			<?php } ?>
			<p>
				...
				<p>
				  <button class="btn btn-L btn-primary" type="button" data-toggle="collapse" data-target="#user_collapse">User accounts<b class="caret caret-body"></b></button>
					<div id="user_collapse" class="collapse">
					  	<button class="btn btn-sub btn-primary" type="button" onclick="window.location.href='/cavex_elSalvador/create_user.php'">Create user</button>
					  	<button class="btn btn-sub btn-primary" type="button" onclick="window.location.href='/cavex_elSalvador/users.php'">View users</button>
				  	</div>
				</p>
			<?php } ?>
			</br>
